...
The Home page failed on the following:

<h2 align="center"><img src="assets/readmeimages/htmlfail.png" width="400px"></h2>
<h2 align="center"><img src="assets/readmeimages/htmlfail1.png" width="400px"></h2>
<h2 align="center"><img src="assets/readmeimages/htmlfail2.png" width="400px"></h2>
<h2 align="center"><img src="assets/readmeimages/htmlfail3.png" width="400px"></h2>

After correcting the errors it passed:

<h2 align="center"><img src="assets/readmeimages/htmlpass.png" width="400px"></h2>

The aboutus page passed :

<h2 align="center"><img src="assets/readmeimages/aboutushtmlcheck.png" width="400px"></h2>

The review page failed:

<h2 align="center"><img src="assets/readmeimages/reviewpagefail.png" width="400px"></h2>

After correcting the errors it passed:

<h2 align="center"><img src="assets/readmeimages/reviewpagepass.png" width="400px"></h2>

The CSS page passed:[W3C CSS Validator](https://jigsaw.w3.org/css-validator/#validate_by_input)

<h2 align="center"><img src="assets/readmeimages/csschecked.png" width="400px"></h2>
...
## Testing User Stories from User Experience  Section
 ...
 - As I first time visitor I would like: 
1. To learn the background of the company
The about page of the website includes an about us section and details of the business policies.
...
More items will be added periodically with new product. All social media platforms have been linked to the site through the icons in the footer.
...
3. Reviews and ratings from other customers are located on the review page.
...
1. I would like to see the website updated and what new items are available.
...
- On my original project I used Bootstrap. I started the project from scratch and did not use Bootstrap for this one because I found it makes things more complicated. 

- I also got rid of the text shadow and used black text to make it more readable.

- I wanted to add a contact form but found time was becoming an issue, so I will add a form at a later date.

- There was a slight horizontal scroll so I added overflow-x: hidden to the body and html which stopped the problem.
